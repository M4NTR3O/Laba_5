...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when{
            intent.getBooleanExtra(DOLLAR, false) -> {textValue.setText(R.string.dollar); result *= 75}
            intent.getBooleanExtra(EURO, false) -> {textValue.setText(R.string.euro); result *= 90}
            intent.getBooleanExtra(POUND, false) -> {textValue.setText(R.string.pound); result *= 100}
        }
